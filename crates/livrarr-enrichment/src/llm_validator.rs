...
//!   - filenames, paths, file sizes, checksums of the user's media
//!   - import_id (could fingerprint the user's external system)
//!   - detail_url (URL the user chose to use — soft privacy concern)
//!   - added_at, monitor flags, or other user-private state
//!
