...
use librarr_db::{ConfigDb, UpdateMediaManagementConfigRequest, UpdateMetadataConfigRequest};
...
fn metadata_to_response(cfg: librarr_db::MetadataConfig) -> MetadataConfigResponse {
