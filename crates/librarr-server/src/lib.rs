...
pub use librarr_db::HistoryFilter;
...
/// Placeholder for download error (from librarr-download).
#[derive(Debug, thiserror::Error)]
#[error("{0}")]
pub struct DownloadError(pub String);

/// Placeholder for import error (from librarr-organize).
#[derive(Debug, thiserror::Error)]
#[error("{0}")]
pub struct ImportError(pub String);

/// Placeholder for metadata error (from librarr-metadata).
#[derive(Debug, thiserror::Error)]
#[error("{0}")]
pub struct MetadataError(pub String);

/// Placeholder for enrichment error (from librarr-metadata).
#[derive(Debug, thiserror::Error)]
#[error("{0}")]
pub struct EnrichmentError(pub String);

/// Placeholder for tag write error (from librarr-tagwrite).
#[derive(Debug, thiserror::Error)]
#[error("{0}")]
pub struct TagWriteError(pub String);

/// Placeholder for scan error (from librarr-organize).
#[derive(Debug, thiserror::Error)]
#[error("{0}")]
pub struct ScanError(pub String);

// =============================================================================
// CRATE: librarr-server
// =============================================================================
