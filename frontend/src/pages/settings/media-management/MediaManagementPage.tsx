      ...
      <PageContent className="space-y-6">
        ...
        <section className="rounded-lg border border-border bg-zinc-900/50">
          <div className="flex items-center gap-2 border-b border-border bg-zinc-800/60 px-5 py-3 rounded-t-lg">
            ...
            <HelpTip text="Where your library files are stored. Add one folder for ebooks and one for audiobooks. Librarr organizes files into Author/Title subfolders within each root." />
          </div>
          <div className="p-5">
        ...
        <section className="rounded-lg border border-border bg-zinc-900/50">
          ...
          {remoteMappings.length > 0 ? (
            ...
            <EmptyState
              ...
              description="Mappings translate paths between your download client and Librarr."
            />
          )}
          </div>
        </section>
        ...
        {isAdmin && (
          <section className="rounded-lg border border-border bg-zinc-900/50">
            <div className="flex items-center gap-2 border-b border-border bg-zinc-800/60 px-5 py-3 rounded-t-lg">
              ...
              <HelpTip text="Calibre-Web Automated (CWA) is a self-hosted ebook manager. When configured, Librarr hardlinks imported ebooks into CWA's ingest folder so they appear in your Calibre library automatically." />
            </div>
            <div className="p-5">
